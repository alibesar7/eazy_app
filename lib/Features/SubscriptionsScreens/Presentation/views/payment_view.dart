...
import 'package:esay_app/Features/SubscriptionsScreens/Presentation/views/widgets/custom_cost_card.dart';
import 'package:esay_app/Features/SubscriptionsScreens/Presentation/views/widgets/custom_data_card.dart';
...
class _PaymentViewState extends State<PaymentView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: "بوابة الدفع"),
            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: Image.asset(AppAssets.assetsIconsEazy),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Image.asset(AppAssets.assetsIconsPadlock3),
                    const Padding(
