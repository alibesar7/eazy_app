      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                ...
                style: AppTextStyles.text16
                    .copyWith(color: const Color(0xffA4ACAD), height: 2.5),
            ...
            SizedBox(child: row),
            SizedBox(height: 6.h),
            // Price row - prices next to each other
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // Both prices next to each other
                  Row(
                    children: [
                      // Regular price
                      Text(
                      ...
                      SizedBox(width: 2.w), // Small space between prices
