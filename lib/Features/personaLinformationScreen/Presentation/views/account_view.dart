import 'package:esay_app/Features/NotificatonsScreen/notificationScreen.dart';
import 'package:esay_app/Features/SubscriptionsScreens/Presentation/views/Upgrade_view.dart';
      ...
      child: Scaffold(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                SizedBox(height: 2.h),
                // Logo row - positioned correctly for RTL
                Row(
                ...
                CustomListTile(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => UpgradeView()));
                  },
                  tilte: "الاشتراكات",
        ...
        bottomNavigationBar: BottomAppBar(
          ...
          child: Row(
            ...
            children: <Widget>[
              // دروسي button on the RIGHT side for RTL
              CustomNavItem(
              ...
              // حسابي button on the LEFT side for RTL
              CustomNavItem(
